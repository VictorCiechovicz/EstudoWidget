...
<span className=" text-xl mt-2">Agardecemos o feedback!</span>
 
 <button 
 type="button"
 onClick={onFeedbackRestartRequested}
 className="py-2 px-6 mt-6 bg-zinc-800 rounded-t-md border-transparent text-sm leading-6 houver:bg-zinc-700 transition-colors focus:border-violet-500 focus:ring-violet-500 focus:ring-1 focus:outline-none resize-none p-2">
